...
class Mywindow(QMainWindow, form_class):
    def __init__(self):
        ...
        self.setupUi(self)
        #db 연결
        self.con = sqlite3.connect("/Users/unanimous0/RL_CompetitiveTradingModel_ver0_1/KOSDAQ_DB/rl_trader.db")
    ...
    def get_lastdate(self):
        lastdate = []
        con2 = sqlite3.connect("/Users/unanimous0/RL_CompetitiveTradingModel_ver0_1/KOSDAQ_DB/rl_trader.db")
        cursor2 = con2.cursor()
